...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "filrot/memote-model-repository" ]]; then
...
echo "Your new report will be visible at https://filrot.github.io/memote-model-repository in a moment."
